...
def doc_toa_thuoc_bang_ai(duong_dan_anh):
    ...
    os.environ["GEMINI_API_KEY"] = "AQ.Ab8RN6KrJBCd6hbU3X2aaUVU-V0ornZdDX6QI5H374IZBJwpxQ"
    client = genai.Client() 
...
def reo_chuong_nhac_nho(ten, lieu, ghi_chu):
    ...
    try:
        notification.notify(
            title=f"ĐẾN GIỜ UỐNG THUỐC: {ten}",
            message=f"Liều: {lieu}\nLưu ý: {ghi_chu}",
            app_name="Trợ Lý Nhắc Thuốc",
            timeout=10
        )
    except Exception as e:
        print(f"Có lỗi khi hiển thị popup: {e}")
...
if __name__ == "__main__":
    ...
    #print("\n[TEST] Bật chế độ test: 10 giây sẽ thông báo 1 lần...")
    #   ten="Thuốc Test Khẩn Cấp", 
     #   lieu="1 viên", 
       # ghi_chu="Uống với nhiều nước"
    #)
